...
#define REQUIRED_SCANF_INPUTS 8 
...
int main(int argc, char* argv[]) {
  ...
  // scanf must match exactly two doubles for each call and this
  // value is checked in the if statement below
  ...
  // print error
  if (scanfsReturnValueAggregatedOverAllScanfs != REQUIRED_SCANF_INPUTS) {
